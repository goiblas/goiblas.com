...
Estaba el otro día escuchando el podcast de los amigos de [freelandev](https://www.freelandev.com/) y comentaban, la necesidad que tenían en varios proyectos de mostrar un listado de un custom post type, como son unos cracks con PHP, ellos utilizan **shortcodes**, una forma perfectamente válida y que el editor de bloques da soporte.
